...
public class RegisterActivity extends AppCompatActivity {
            ...
            } else
            {
                ...
                } else
                {
                    ...
                    } else
                    {
                        ...
                        {
                            Toast.makeText(this, "Password does'n match !", Toast.LENGTH_SHORT).show();
                        } else
                        {
                            createUserAccount();
                        }
    ...
    private void updateUserInfo()
    {
        ...
        //get current user uid(user ID), since user is registered so we can get now
        ...
        ref.child(uid).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                startActivity(new Intent(RegisterActivity.this, HomePageUserActivity.class));
                finish();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
